...
public class Manager {
  ...
  /**
   * Controla que la contraseña sea mayor de 8 carácteres y tiene mayuscula y
   * número.
   * 
   * @param contrs.
  ...
  /**
   * Comprueba la validez del dni 9 carácteres y letra correcta.
   * 
   * @param dni.
  ...
  /**
   * Comprueba que el número de la seguridad social es correcto.
   * 
   * @param numSS.
   ...
   */
  public Usuario register(String dni, String nombre, String apellidos, String contrs, String numSS, int idEspecialidad)
      throws Exception {
   ...
   */
  public Cita modificarCita(String dniPaciente, String especialidad, String fechaActual, String fechaModificar)
   ...
   * @throws ParseException.
   */
  public Especialidad crearEspecialidad(String nombrEspecialidad, String tiempoCita, String horaInicio, String horaFin)
      throws Exception {
   ...
   * @throws Exception.
   */
  public Especialidad modificarEspecialidad(String nombre, String duracionOld, String horaInicioOld, String horaFinOld,
      String duracionNew, String horaInicioNew, String horaFinNew) throws Exception {
  ...
  private List<String> controlarHoras(LocalDateTime fechaDia, int duracion, LocalDateTime horaInicio,
    ...
    while (continuar) {
      ...
      for (int i = 0; i < citasMedico.size(); i++) {
        LocalDateTime fechaCita = citasMedico.get(i).getFecha().toInstant().atZone(ZoneId.systemDefault())
            .toLocalDateTime();

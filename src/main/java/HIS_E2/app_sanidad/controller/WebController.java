...
public class WebController {
  ...
  /**
   * Recibe peticiones POST de consulta de las horas en las que un paciente tiene
   * citas.
   * 
   * @param jso el cuerpo de la petición.
  ...
  public Map<String, Object> modificarEspecialidad(@RequestBody Map<String, String> jso) throws Exception {
    ...
    Especialidad especialidad = Manager.get().modificarEspecialidad(nombre, duracionOld, horaInicioOld, horaFinOld,
   ...
   * @throws Exception.
   */
  @PostMapping(value = "/consultaCentro")
  public Map<String, Object> consultarCentro(@RequestBody Map<String, String> jso) throws Exception {
    Centro centro = Manager.get().consultarCentro(jso.get("nombreCentro"), jso.get("localidadCentro"));
    Map<String, Object> respuesta = new HashMap<String, Object>();
    respuesta.put("type", "OK");

    respuesta.put("nombreCentro", centro.getNombre());

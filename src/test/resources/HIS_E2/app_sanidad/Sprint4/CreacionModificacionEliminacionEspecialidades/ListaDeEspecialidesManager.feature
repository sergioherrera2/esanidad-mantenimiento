...
Feature: Como administrador quiero ver la lista de especialidades
  ...
  Scenario: Como administrador quiero visualizar la lista de especialdiades
   Given Tengo dni "05726279S",duracion "15",hora inicio "9:00",hora final "13:00"
    ...
    Then borro la especialidad dni "05726279S",duracion "15",hora inico "9:00",hora final "13:00",response "OK"

...
public class StepsdefsSprint4adminMedicos extends JunitTests2 {
  ...
  public void el_medico_ha_sido_guardado_correctamente_dni_especialidad_response(String arg1, String arg2,
      String arg3) {
    if (arg3.equals("OK")) {
      try {
  ...
  public void envio_peticion_crear_medico_dni_especialidad_response(String arg1, String arg2, String arg3) {
    ...
    request = new Request.Builder().url("https://esanidad.herokuapp.com/crearMedico").post(body)
        .addHeader("Content-Type", "application/json").addHeader("cache-control", "no-cache")
        .addHeader("Postman-Token", "774c3406-0328-4313-88f8-56ac75e600a2").build();
  }
  ...
  public void envio_peticion_de_crear_medicco_dni_especlialidad_response(String arg1, String arg2, String arg3) {
    ...
    request = new Request.Builder().url("https://esanidad.herokuapp.com/crearMedico").post(body)
        .addHeader("Content-Type", "application/json").addHeader("cache-control", "no-cache")
        .addHeader("Postman-Token", "907529fd-13c9-436d-bd25-a8af5dbe6492").build();
  }
  ...
  public void pido_lista_de_médicos_web() {
    ...
    RequestBody body = RequestBody.create(mediaType,
        "{\"dni\":\"05726690N\",\"nombre\":\"Hector Cespedes\",\"especialidad\":\"Podología\"}");
    request = new Request.Builder().url("https://esanidad.herokuapp.com/listaMedicos").post(body)
        .addHeader("Content-Type", "application/json").addHeader("cache-control", "no-cache")
        .addHeader("Postman-Token", "37ebd8d3-96eb-473e-b143-4ac8b89aabd0").build();
  }
  ...
  public void relleno_los_campos_de_eliminacion_medico_dni_especialidad_response(String arg1, String arg2,
      String arg3) {
    try {
  ...
  public void envio_peticion_de_eliminar_medico_dni_especlialidad_response(String arg1, String arg2, String arg3) {
    ...
    request = new Request.Builder().url("https://esanidad.herokuapp.com/eliminarMedico").post(body)
        .addHeader("Content-Type", "application/json").addHeader("cache-control", "no-cache")
        .addHeader("Postman-Token", "907529fd-13c9-436d-bd25-a8af5dbe6492").build();
  }
}
